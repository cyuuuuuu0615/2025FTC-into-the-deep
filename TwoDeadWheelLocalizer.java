...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -2799.618796678729; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -2217.979457672742; // x position of the perpendicular encoder (in tick units)
    }
